...
/**
 * In the code editor, the TypesOfFood component is already rendering a component called Vegitables. Also, there is the Fruits component from the last challenge.
 * 
 * Nest two components inside of Fruits - first NonCitrus, and then Citrus. Both of these components are provided for you behind the scenes. Next, nest the Fruits class component into the TypesOfFood component, below the h1 heading element and above Vegitables. The result should be a series of nested components, which uses two different component types.
 */
 ...
 * 
 * ReactDOM.render(componentToRender, targetNote).
 * 
 ...
 * 
 * ReactDOM.render(<ComponentToTender />, targetNode)
 * 
...
/**
 * Both the Fruits and Vegetables components are defined for you behind the scenes. Render both components as children of the TypesOfFood component, then render TypesOfFood component, then render TypesOfFood to the DOM. There is a div with id='challenge-node' available for you to use.
 */
